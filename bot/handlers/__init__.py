...
try:
    ...
    logger.critical(f"❌ Не удалось загрузить commands.router: {e}")
...
try:
    ...
    logger.critical(f"❌ Не удалось загрузить callbacks.router: {e}")
...
try:
    ...
    logger.critical(f"❌ Не удалось загрузить topics routers: {e}")
...
try:
    ...
    logger.critical(f"❌ Не удалось загрузить admin_migration: {e}")
